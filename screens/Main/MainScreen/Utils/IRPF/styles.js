...
export const getStyles = (theme) => StyleSheet.create({
  ...
  searchButton: { flexDirection: 'row', alignItems: 'center', justifyContent: 'center', borderWidth: 1, borderColor: '#ccc', borderRadius: 10, padding: 15, backgroundColor: theme.buttonBackground, width: '100%', bottom: -10, marginBottom: 10 },
  searchButtonText: { color: theme.buttonTextColor, fontSize: 14, fontWeight: 'bold', marginRight: 5  },
  ...
  actionText: { color:  theme.inputTextColor, marginTop: 5, fontSize: 14 },
  noCards: { color: '#333', textAlign: 'center', marginTop: 60 },
  errorMessage: { fontSize: 12, color: 'red', marginTop: 5 },
  inputContainer: { borderColor: theme.inputTextColor, borderWidth: 0, borderRadius: 8, backgroundColor: theme.backgroundColor, paddingHorizontal: 1, marginBottom: 1, flexDirection: 'row', alignItems: 'center', width: '100%', color: theme.textColor },
